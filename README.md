...
A continuación se presentan los resultados obtenidos mediante el uso del modelo random forest, en el siguiente archivo .csv: predicciones_random_forest.csv
## Conclusiones
